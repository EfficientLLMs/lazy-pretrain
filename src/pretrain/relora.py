"""
This is the same as https://github.com/Guitaricet/relora/blob/main/peft_pretraining/relora.py
"""
...
class ReLoRaConfig:
    ...
    # Most cases we will keep keep_original_weights=True and lora_only=False
    keep_original_weights: bool  # whether to keep original weights. True: W+BA; False: only BA
    lora_only: bool = False  # True: forward pass only computes BA*scale
    trainable_scaling: bool = False  # whether to make the scaling factor (alpha/r) trainable
    quantize: str = None
