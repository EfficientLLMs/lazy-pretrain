#!/bin/bash
#SBATCH --job-name=2b_full_70m_410m_step142000-1e-5
#SBATCH --mem=32G
#SBATCH --gres=gpu:A6000:6
#SBATCH --output=.slurm_logs/2b_full_70m_410m_step142000-1e-5.out
...
accelerate launch src/pretrain/pretrain_full.py \
    ...
    --batch_size 8 \
    --lr 1e-5 \
    --output_dir "models/pythia-70m-step142000-to-pythia-410m-full-2b-1e-5" \
    --use_on_the_fly \
    --first_idx 19 \
    --last_idx 20 \
