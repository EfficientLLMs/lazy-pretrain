#!/bin/bash
#SBATCH --job-name=pythia-70m-step140000-1b-lora-alpha256-allmod-1e-5
#SBATCH --mem=32G
#SBATCH --gres=gpu:A6000:8
#SBATCH --output=.slurm_logs/pythia-70m-step140000-1b-lora-alpha256-allmod-1e-5.out
...
accelerate launch src/pretrain/pretrain_lora.py \
    ...
    --batch_size 64 \
    --lr 1e-5 \
    --output_dir "models-xinyue/pythia-70m-step140000-1b-lora-alpha256-allmod-1e-5" \
    --use_on_the_fly \
    --first_idx 19 \
    --last_idx 20 \
    --num_tokens 1_000_000_000 \
