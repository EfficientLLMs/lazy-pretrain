#!/bin/bash
#SBATCH --job-name=2b_full-1e-5-pythia-70m-step143000-to-pythia-410m
#SBATCH --mem=32G
#SBATCH --gres=gpu:A100_40GB:4
#SBATCH --output=.slurm_logs/2b_full-1e-5-pythia-70m-step143000-to-pythia-410m.out
